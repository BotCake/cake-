...
admin = ["u2d969296b48bc0304055dc595c7a6e44"]
...
admins = ["u2d969296b48bc0304055dc595c7a6e44"]
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"แอดมารักหรือแอดมารันครับ",
    "lang":"JP",
    "comment":"Auto like BOT ",
    "likeOn":False,
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
...
#--------------------------------------------------------
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"🙉 ลบเสร็จแล้วงับ🙉")
                else:
                    cl.sendText(msg.to,"key is wrong。")
                     ...
                     if targets == []:	
                       ...
                       for target in targets:
                         try:
                            ...
                            cl.sendText(msg.to, "🐒แปรงร่างเป็น🐒")	
...
#-----------------------------------------------------------speed
                ...
                if wait["blacklist"] == {}:
                    ...
                    cl.sendText(msg.to,"ƁЄԼƠƜ ƖƧ ƛ ƁԼƛƇƘԼƖƧ")
                    mc = ""
                    for mi_d in wait["blacklist"]:
                        mc += "😎ติดดำ😎"  +cl.getContact(mi_d).displayName + "\n"
                    cl.sendText(msg.to,mc)
                ...
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += "😎ติดดำ😎"  +cl.getContact(mm).displayName + "\n"
